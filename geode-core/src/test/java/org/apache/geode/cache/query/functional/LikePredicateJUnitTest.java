...
public class LikePredicateJUnitTest {
  ...
  public void testLikePredicateOnNullValues() throws Exception {
    ...
    String query[] = new String[] {"SELECT distinct *  FROM /pos ps WHERE ps.pkid like '%b%'",
  ...
  public void testQueryExecutionMultipleTimes() throws Exception {
    ...
    executeQueryMultipleTimes("SELECT distinct *  FROM /pos ps WHERE ps.status like 'in%ve'",
        false);
